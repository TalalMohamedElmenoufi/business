...
list($emailUso) = mysqli_fetch_row(mysqli_query($conexao2, "select count(id) from t_".$dataTabela."_emailStatuses where date LIKE '%$dataSel01%' "));
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
					<h2 >Dashboard EMAIL MARKETING</h2>
				</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px;">
	...
	<div credito>
		...
		<span creditoQnt><?=$creditoEmail?></span>	
	</div>	
...
$.ajax({
url: './tabelas/graficos_email/montar.php?MesAno='+MesAno+'&Mes_Ano='+Mes_Ano,
...
AtGrafico('<?=$dataTabela?>','<?=$dataSel01?>');	
	...
	$('#MesAno').change(function(){
		...
		//alert(TmesAno[2] +" e "+TmesAno[1]);
		
		$.ajax({
		url: './acoes/checar_quantidade_email.php?MesAno='+TmesAno[2]+'&Mes_Ano='+TmesAno[1]+'&DiaMes1='+DiaMes1,
