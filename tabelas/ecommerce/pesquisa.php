...
$Conf[script] = 'tabelas/ecommerce/pesquisa';
$Script = md5($Conf[script]);

$pergunta = "select * from pesquisas_planos order by ordem";
...
?>	
	...
	<div class="col-lg-4 col-md-4 w3-card " >	
			...
			<span>R$<code style="color:#010096"><?=number_format($d->valor_unitario,4,",",".")?></code>/pesquisa</span>	
		    </p>

			<ul class="list-star">
			  <li>Pesquisas para medir o clima organizacional.</li>
			  <li>Net Promoter Score – NPS.</li>
			  <li>Pesquisa 360º Graus.</li>
			  <li>Medir o clima organizacional.</li>
			  <li>Dentre outros ...</li>
			</ul>
...
$(".Comprar").click(function(){
	...
	let QuantidadePlano = $(this).attr("QuantidadePlano");
      ...
      $.confirm({
		...
		content: "Em desenvolvimento...<br>Favor solicitar via e-mail:<br> <b>financeiro@elmenoufi.com.br</b>",
     ...
     /*SolicitandoCredir = $.confirm({
		title: "<span style='color:green'>INFORMAÇÕES!</span>",
		content: "url:./tabelas/ecommerce/info_vencimento_pesquisa.php?Cod="+Cod+"&ValorPlano="+ValorPlano+"&ValorWhast="+ValorWhast+"&ValorPlanoSend="+ValorPlanoSend+"&QuantidadePlano="+QuantidadePlano,
		columnClass:"col-md-4 col-md-offset-4",
		theme: "light",
		buttons: {
			Cancelar: {
