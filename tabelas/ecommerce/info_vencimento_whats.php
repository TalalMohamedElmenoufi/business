<div id="AcessarMeusPlanosWhats">
<?php
include('../../includes/connect.php');
include('../../includes/funcoes.php');
	
$Conf[script] = 'tabelas/ecommerce/info_vencimento_whats';
...
if(!$_SESSION[$Script][ValorWhast]){$_SESSION[$Script][ValorWhast] = $_GET[ValorWhast];}
if($_GET[ValorWhast]){$_SESSION[$Script][ValorWhast] = $_GET[ValorWhast];}
...
//var_dump($response);	
	...
	$insert = " insert into asaas_cobranca_whatsapp set
				object = '".$obj->object."',
				id = '".$obj->id."',
...
<label>Pagando R$ <b><?=$_SESSION[$Script][ValorWhas]?>/whats</b></label>
...
submitHandler: function( form ){
	...
	$.ajax({
		type: "POST",
		url: "./tabelas/ecommerce/info_vencimento_whats.php",
		data: dados,
		success: function( data )
		{
			$("#AcessarMeusPlanosWhats").html(data);
...
function IrMeusPlanos(c,d){
	...
	$.ajax({
		type: "GET",
		url: "./tabelas/minhas_faturas/faturas_whatsapp.php",
		data: {
			Cod:c,
			data_vencimento:d
		},
