...
$pergunta = "select * from usuarios where status_whats_desc = 'CONNECTED' and id != '38' ";
...
function ListaAniversariantes($conexao,$conexao2,$maxId,$ip,$porta,$token,$credito_atual_whats,$cliente){
		...
		while($d = mysqli_fetch_object($resultado)){
			...
			SendWhats($conexao,$conexao2,$maxId,$ip,$porta,$token,$d->id_cadastro,$d->id,$d->destination,$d->mensagem,$credito_atual_whats,$cliente);
		}
