...
$Conf[script] = 'tabelas/cobrancas_externas/cobrancas_externas_sms';
...
list($cobrancaSms) = mysqli_fetch_row(mysqli_query($con, "select count(id_rg) from asaas_cobranca_sms where dueDate like '%$AnoMes%' and status = 'PENDING' "));		
	
$CobrancasEx += $cobrancaSms ;
	
}
$_SESSION[$Script][nr] = $CobrancasEx;


$_SESSION[$Script][dialog] = 'CONTEUDOS';
$_SESSION[$Script][url] = 'tabelas/cobrancas_externas/cobrancas_externas_sms';
$_SESSION[$Script][titulo] = ('Cobranças de clientes sms');
...
$con = mysqli_connect("localhost", "root", "Pr0v!s@2024S!st3m@", "elmenoufi_bot_".$c->id);	
		...
		$pergunta = "select a.*, b.nome from elmenoufi_bot_".$c->id.".asaas_cobranca_sms a
