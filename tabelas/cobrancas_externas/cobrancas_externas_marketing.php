...
$Conf[script] = 'tabelas/cobrancas_externas/cobrancas_externas_marketing';
...
list($cobrancaWhats) = mysqli_fetch_row(mysqli_query($con, "select count(id_rg) from asaas_cobranca_email where dueDate like '%$AnoMes%' and status = 'PENDING' "));			
...
$_SESSION[$Script][url] = 'tabelas/cobrancas_externas/cobrancas_externas_marketing';
$_SESSION[$Script][titulo] = ('Cobranças de clientes e-mail marketing');
...
$con = mysqli_connect("localhost", "root", "Pr0v!s@2024S!st3m@", "elmenoufi_bot_".$c->id);	
		...
		$pergunta = "select a.*, b.nome from elmenoufi_bot_".$c->id.".asaas_cobranca_email a
