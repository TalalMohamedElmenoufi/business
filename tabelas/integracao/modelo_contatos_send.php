...
function EnviarWhats($email,$senha,$numeros,$mensagem){
	...
	$ch = curl_init();
	curl_setopt( $ch,CURLOPT_URL, 'https://elmenoufi.com.br/business/integracao/contatos_send.php' );
...
<form action="modelo_contatos_send.php" method="post" enctype="multipart/form-data" >
	...
	<input type="text" name="mensagem" placeholder="Responda *Sim* para receber informações das nossa aplicações ou *Não* para não receber mais estes tipos de informações" class="form-control"/>
