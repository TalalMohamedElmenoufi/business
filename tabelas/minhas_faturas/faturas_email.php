...
$Conf[script] = 'tabelas/minhas_faturas/faturas_email';
	$Script = md5($Conf[script]);
    list($_SESSION[$Script][nr]) = mysqli_fetch_row(mysqli_query($conexao2, "select count(id_rg) from asaas_cobranca_email  "));
	$_SESSION[$Script][dialog] = 'CONTEUDOS';
    $_SESSION[$Script][url] = 'tabelas/minhas_faturas/faturas_email';
	$_SESSION[$Script][titulo] = 'Faturas E-mail';
	...
	if($_POST){
		mysqli_query($conexao2,"delete from asaas_cobranca_email where id_rg in (".@implode(",",$_POST[CheckOpc]).")");
...
<div class="col-lg-12 col-md-12" style="margin-top:10px;">
		...
		$pergnta = "select a.* from asaas_cobranca_email a
        ...
        ?> 
              <tr class="AoclicarList">
                ...
                <td Editar cod="<?=$d->id_rg?>" ><?=($d->status)?> </td> 
