...
list($smsEnvio) = mysqli_fetch_row(mysqli_query($conexao2, "select count(id) from cadastro where categoria in (".implode(',',$_POST[grupos]).") and situacao = '0' and tel_tipo = 'WhatsApp'  "));
