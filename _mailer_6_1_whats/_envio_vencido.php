...
$mensagens  = "Sistema business T M Elmenoufi\n";
...
$mensagens .= "_Caso você tenha efetuado o pagamento desta cobrança nas últimas 48 horas, favor desconsiderar esta mensagem_.\n\n";	
$mensagens .= "*".$link2."*";
...
function SendEmail($nome, $value, $dueDate, $description, $invoiceUrl, $emailSend, $emails, $logo, $empresa, $cpf_cnpj, $site, $email, $contato, $endereco, $cep, $cidade, $estado){
	...
	$html  .= '<span style="font-weight:100;font-size:14pt;">N&atilde;o foi poss&iacute;vel registrar o pagamento da sua cobran&ccedil;a gerada por '.$empresa.' no valor de <b>R$ '.number_format($value,2,",",".").'</b> com vencimento em <b>'.dataBr($dueDate).'</b></span>.<br>';
	...
	$html  .= 'Caso voc&ecirc; tenha efetuado o pagamento desta cobran&ccedil;a nas &uacute;ltimas 48 horas, favor desconsiderar esta mensagem.';
