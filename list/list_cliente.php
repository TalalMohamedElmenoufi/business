...
list($stDoc) = mysqli_fetch_row(mysqli_query($conexao, "select stDoc from asaas where id_usuario = '".$_SESSION[id_usuario]."' "));
	
$NovoR = (($stDoc=='APPROVED') ? 'Novo' : 'Aprovacao' ) ;	
?>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
		...
		<div class="row"> 
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
				...
				<i class="fas fa-plus-circle NovoRegistro TitlePadrao" id="<?=$NovoR?><?=$_SESSION[$Script][Novo]?>" data-toggle="tooltip" data-placement="top" title="Novo registro"></i>
...
$('[data-toggle="tooltip"]').tooltip();
		...
		$("#Aprovacao<?=$_SESSION[$Script][Novo]?>").click( function(){ 

			 $.confirm({
				title: "<span style='color:#CC040A'>ATENÇÃO!</span>",
				content: "Cadastro de sua conta bancaria <b>pendente</b>!",
