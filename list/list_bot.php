		...
		<div class="row"> 	
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="row"> 
					...
					<i style="display:<?=(($creditos)?'block':'none')?>" class="fas fa-plus-circle NovoRegistro TitlePadrao" id="Novo<?=$_SESSION[$Script][Novo]?>" data-toggle="tooltip" data-placement="top" title="Novo registro"></i>

					<i style="display:<?=(($creditos)?'none':'block')?>" class="fas fa-hand-holding-usd NovoRegistro TitlePadrao" id="NovoCredito<?=$_SESSION[$Script][NovoCredito]?>" data-toggle="tooltip" data-placement="top" title="Solicitar créditos"></i>	
					</div>
...
$('[data-toggle="tooltip"]').tooltip();
		...
		$("#NovoCredito<?=$_SESSION[$Script][Novo]?>").click( function(){ 

		   $("#CARREGANDO").html('<div id="loader"><img src="./img/loader.gif" width="120" ></div>');
			
				$.ajax({
				  url: './paginas/solicitar_credito.php',
