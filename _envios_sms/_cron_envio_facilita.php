...
function EnviarSMS($conexao2,$codigo,$data,$grupos,$mensagem,$timezone){
		...
		while($d = mysqli_fetch_object($resultado)){
			...
			/*$msgEncoded = urlencode("T M Elmenoufi Ltda");
			$urlChamada = "https://www.facilitamovel.com.br/api/simpleSend.ft?user=talalelmenoufi&password=3lm3n0uf!&destinatario=5592991725319&msg=".$msgEncoded;
